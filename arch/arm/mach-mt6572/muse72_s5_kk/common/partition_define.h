...
#define PART_SIZE_FTM			(8192*KB)
#define PART_SIZE__EXT_PL			(512*KB)
...
#define PART_SIZE_SEC_RO			(512*KB)
...
#define PART_SIZE_CUST			(102400*KB)
#define PART_SIZE_RCT			(1024*KB)
#define PART_SIZE_FACTORY			(20480*KB)
#define PART_SIZE_ANDROID			(1536000*KB)
#define PART_SIZE_CACHE			(350208*KB)
#define PART_SIZE_USRDATA			(1638400*KB)
