...
#define PHYSICAL_WIDTH  (52)  // mm
#define PHYSICAL_HEIGHT (86)  // mm
...
static void init_lcm_registers(void)
{
	...
	data_array[2] = 0x3726240e;
	data_array[3] = 0x0b06401a;
	data_array[4] = 0x1113100d;
	data_array[5] = 0x00161214;
	data_array[6] = 0x26240604;
	data_array[7] = 0x063d1237;
	data_array[8] = 0x13110d0b;
	data_array[9] = 0x16121411;
