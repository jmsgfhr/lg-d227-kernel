...
#define IMAGE_SENSOR_PV_GRAB_START_Y        (0)
...
#define IMAGE_SENSOR_FULL_GRAB_START_Y      (0)
...
//60Hz
{
	...
	{0xb9, 0x66, BURST_TYPE}, // STEVE outdoor bluish // steve OutRgainMin
	{0xba, 0x88, BURST_TYPE}, // STEVE outdoor bluish // steve OutRgainMax
	{0xbb, 0x4c, BURST_TYPE}, // STEVE outdoor bluish // steve OutBgainMin
	{0xbc, 0x62, BURST_TYPE}, // STEVE outdoor bluish // steve OutBgainMax
...
HI351_I2C_REG_STRUCT HI351_Preview_Setting[2][109]={
{//60Hz
	...
	{0x4B, 0x11, BURST_TYPE},
	{0x4C, 0x11, BURST_TYPE},
	{0x4D, 0x21, BURST_TYPE},
	{0x4E, 0x44, BURST_TYPE},
	{0x4F, 0x44, BURST_TYPE},
	{0x50, 0x12, BURST_TYPE},
	{0x51, 0x11, BURST_TYPE},
	{0x52, 0x11, BURST_TYPE},
	{0x53, 0x22, BURST_TYPE},
	{0x54, 0x44, BURST_TYPE},
	{0x55, 0x44, BURST_TYPE},
	{0x56, 0x22, BURST_TYPE},
	{0x57, 0x11, BURST_TYPE},
	{0x58, 0x21, BURST_TYPE},
	{0x59, 0x44, BURST_TYPE},
	{0x5A, 0x44, BURST_TYPE},
	{0x5B, 0x44, BURST_TYPE},
	{0x5C, 0x44, BURST_TYPE},
	{0x5D, 0x12, BURST_TYPE},
	{0x5E, 0x21, BURST_TYPE},
	{0x5F, 0x44, BURST_TYPE},
	{0x60, 0x44, BURST_TYPE},
	{0x61, 0x44, BURST_TYPE},
	{0x62, 0x44, BURST_TYPE},
	{0x63, 0x12, BURST_TYPE},
	{0x64, 0x21, BURST_TYPE},
	{0x65, 0x44, BURST_TYPE},
	{0x66, 0x44, BURST_TYPE},
	{0x67, 0x44, BURST_TYPE},
	{0x68, 0x44, BURST_TYPE},
	{0x69, 0x12, BURST_TYPE},
	{0x6A, 0x11, BURST_TYPE},
	{0x6B, 0x11, BURST_TYPE},
	{0x6C, 0x11, BURST_TYPE},
	...
	{0x20, 0x04, BURST_TYPE}, //ZOOM_DST_WIDTH_H
	{0x21, 0x00, BURST_TYPE}, //ZOOM_DST_WIDTH_L
	{0x22, 0x03, BURST_TYPE}, //ZOOM_DST_HEIGHT_H
	{0x23, 0x00, BURST_TYPE}, //ZOOM_DST_HEIGHT_L
	{0x24, 0x00, BURST_TYPE}, //ZOOM_WIN_STX_H
	{0x25, 0x03, BURST_TYPE}, //ZOOM_WIN_STX_L	 STEVE00 value changed : 0x03 -) 0x01
	{0x26, 0x00, BURST_TYPE}, //ZOOM_WIN_STY_H
	{0x27, 0x00, BURST_TYPE}, //ZOOM_WIN_STY_L
	{0x28, 0x04, BURST_TYPE}, //ZOOM_WIN_ENX_H
	{0x29, 0x03, BURST_TYPE}, //ZOOM_WIN_ENX_L	 STEVE00 value changed : 0x83 -) 0x81
	{0x2a, 0x03, BURST_TYPE}, //ZOOM_WIN_ENY_H
	{0x2b, 0x00, BURST_TYPE}, //ZOOM_WIN_ENY_L
	{0x2c, 0x08, BURST_TYPE}, //ZOOM_VER_STEP_H
	{0x2d, 0x00, BURST_TYPE}, //ZOOM_VER_STEP_L
	{0x2e, 0x08, BURST_TYPE}, //ZOOM_HOR_STEP_H
	{0x2f, 0x00, BURST_TYPE}, //ZOOM_HOR_STEP_L
	{0x30, 0x04, BURST_TYPE}, //ZOOM_FIFO_DELAY
	{0x30, 0x04, BYTE_LEN}, //ZOOM_FIFO_DELAY
	{0x03, 0x00, BYTE_LEN},
	...
	{0x31, 0x08, BYTE_LEN}, // STEVE for 1024x768 5-)8

	{0x03, 0x30, BYTE_LEN},
	{0x36, 0x28, BYTE_LEN}, //Preview set

	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x0F, DELAY_TYPE},

	{0x03, 0x11, BYTE_LEN},
	{0xf0, 0x0d, BYTE_LEN}, // STEVE Dark mode for Sawtooth

	{0x03, 0xc4, BYTE_LEN}, //AE en
	{0x10, 0xe1, BYTE_LEN}, // STEVE AE ON    (50hz : 0xe9, 60hz : 0xe1)
...
HI351_I2C_REG_STRUCT HI351_FullPreview_Setting[]={
	{0x03, 0x00, BYTE_LEN},
	...
	{0x36, 0xa3, BYTE_LEN},
	//{0x03, 0xFE, BYTE_LEN},
	//{0xFE, 0x0A, BYTE_LEN}, //Delay MUST WAIT 10msec
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x0F, DELAY_TYPE},
	...
	{0x03,0x11, BYTE_LEN},
	{0xf0,0x00, BYTE_LEN}, //DMA Auto

	{0x03, 0x15, BYTE_LEN}, //Shading
	{0x10, 0x81, BYTE_LEN}, // 00 -> 83 LSC ON
	{0x20, 0x07, BYTE_LEN},
	{0x21, 0xf8, BYTE_LEN},
	{0x22, 0x05, BYTE_LEN},
	{0x23, 0xf8, BYTE_LEN},
	...
	//{0x03, 0xFE, BYTE_LEN},
	//{0xFE, 0x14, BYTE_LEN}, //Delay 20ms 16 ms delay but actual delay in measurement is 20 ms
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x19, DELAY_TYPE},
...
HI351_I2C_REG_STRUCT HI351_Capture_Setting[2][60]={
{//60Hz
	{0x03, 0x00, BYTE_LEN},
	{0x01, 0xf1, BYTE_LEN}, //Sleep on
	...
	{0x03, 0xc4, BYTE_LEN}, //AE off
	{0x10, 0x60, BYTE_LEN}, // STEVE AE OFF   (50Hz : 0x68, 60hz : 0x60)
	...
	{0x03, 0x19, BYTE_LEN}, //Scaler Off
	{0x10, 0x87, BYTE_LEN},
	{0x20, 0x08, BURST_TYPE},
	{0x21, 0x00, BURST_TYPE},
	{0x22, 0x06, BURST_TYPE},
	{0x23, 0x00, BURST_TYPE},
	{0x24, 0x00, BURST_TYPE},
	{0x25, 0x0a, BURST_TYPE}, // Xstart
	{0x26, 0x00, BURST_TYPE},
	{0x27, 0x08, BURST_TYPE}, // Y start
	{0x28, 0x08, BURST_TYPE},
	{0x29, 0x0a, BURST_TYPE}, // Xend
	{0x2a, 0x06, BURST_TYPE},
	{0x2b, 0x08, BURST_TYPE}, // Y end
	{0x2c, 0x08, BURST_TYPE},
	{0x2d, 0x00, BURST_TYPE},
	{0x2e, 0x08, BURST_TYPE},
	{0x2f, 0x00, BURST_TYPE},
	{0x30, 0x04, BURST_TYPE},
	{0x30, 0x04, BYTE_LEN},
...
{//50Hz
	...
	{0x03, 0xc4, BYTE_LEN}, //AE off
	{0x10, 0x68, BYTE_LEN},  // STEVE AE OFF   (50Hz : 0x68, 60hz : 0x60)
	{0x03, 0xc5, BYTE_LEN}, //AWB off
	{0x10, 0x30, BYTE_LEN},
...
HI351_I2C_REG_STRUCT HI351_Video_30fps_Setting[2][149]={
{//60Hz
	// CAMCODER MODE : 30 ~ 15FPS
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x14, DELAY_TYPE}, // STEVE DELAY
	{0x03, 0x00, BYTE_LEN},
	{0x01, 0xf1, BYTE_LEN}, //Sleep on
	...
	{0x4B, 0x11, BURST_TYPE},
	{0x4C, 0x11, BURST_TYPE},
	{0x4D, 0x11, BURST_TYPE},
	{0x4E, 0x11, BURST_TYPE},
	{0x4F, 0x11, BURST_TYPE},
	{0x50, 0x11, BURST_TYPE},
	{0x51, 0x11, BURST_TYPE},
	{0x52, 0x11, BURST_TYPE},
	{0x53, 0x11, BURST_TYPE},
	{0x54, 0x11, BURST_TYPE},
	{0x55, 0x11, BURST_TYPE},
	{0x56, 0x11, BURST_TYPE},
	{0x57, 0x11, BURST_TYPE},
	{0x58, 0x11, BURST_TYPE},
	{0x59, 0x11, BURST_TYPE},
	{0x5A, 0x11, BURST_TYPE},
	{0x5B, 0x11, BURST_TYPE},
	{0x5C, 0x11, BURST_TYPE},
	{0x5D, 0x11, BURST_TYPE},
	{0x5E, 0x11, BURST_TYPE},
	{0x5F, 0x11, BURST_TYPE},
	{0x60, 0x11, BURST_TYPE},
	{0x61, 0x11, BURST_TYPE},
	{0x62, 0x11, BURST_TYPE},
	{0x63, 0x11, BURST_TYPE},
	{0x64, 0x11, BURST_TYPE},
	{0x65, 0x11, BURST_TYPE},
	{0x66, 0x11, BURST_TYPE},
	{0x67, 0x11, BURST_TYPE},
	{0x68, 0x11, BURST_TYPE},
	{0x69, 0x11, BURST_TYPE},
	{0x6A, 0x11, BURST_TYPE},
	{0x6B, 0x11, BURST_TYPE},
	{0x6C, 0x11, BURST_TYPE},
	{0x6D, 0x11, BURST_TYPE},
	...
	{0xae, 0x03, BURST_TYPE}, // dark2
	{0xaf, 0x14, BURST_TYPE},
	{0xb0, 0x10, BURST_TYPE},
	{0xb1, 0x27, BURST_TYPE},
	{0xb2, 0x11, BURST_TYPE},
	{0xb3, 0x0f, BURST_TYPE},
	{0xb4, 0x12, BURST_TYPE},
	{0xb5, 0x0f, BURST_TYPE},
	{0xb6, 0x13, BURST_TYPE},
	{0xb7, 0xa3, BURST_TYPE},
	{0xb8, 0x14, BURST_TYPE},
	{0xb9, 0x3c, BURST_TYPE},
	{0xba, 0x15, BURST_TYPE},
	{0xbb, 0x18, BURST_TYPE},
	{0xbc, 0x16, BURST_TYPE},
	{0xbd, 0x10, BURST_TYPE},
	{0xbe, 0x17, BURST_TYPE},
	{0xbf, 0x08, BURST_TYPE},
	{0xc0, 0x18, BURST_TYPE},
	{0xc1, 0x32, BURST_TYPE},
	{0xc2, 0x19, BURST_TYPE},
	{0xc3, 0x30, BURST_TYPE},
	{0xc4, 0x1a, BURST_TYPE},
	{0xc5, 0x30, BURST_TYPE},
	{0xc6, 0x20, BURST_TYPE},
	{0xc7, 0x80, BURST_TYPE},

	{0x03, 0x20, BYTE_LEN}, //Page 20
	{0x24, 0x00, BYTE_LEN}, //EXP Max 15.00 fps (60Hz)
	{0x25, 0x24, BYTE_LEN},
	{0x26, 0x9b, BYTE_LEN},
	{0x27, 0x40, BYTE_LEN},
	...
	{0x90, 0x08, BYTE_LEN}, //BLC_TIME_TH_ON
	{0x91, 0x08, BYTE_LEN}, //BLC_TIME_TH_OFF
	{0x92, 0xe8, BYTE_LEN}, //BLC_AG_TH_ON  //STEVE AGC OxD0
	{0x93, 0xe0, BYTE_LEN}, //BLC_AG_TH_OFF //STEVE AGC OxD0

	//DCDC
	{0x03, 0x02, BYTE_LEN}, //PAGE 2
	{0xd4, 0x08, BYTE_LEN}, //DCDC_TIME_TH_ON
	{0xd5, 0x08, BYTE_LEN}, //DCDC_TIME_TH_OFF
...
{//50Hz
	...
	{0x03, 0x20, BYTE_LEN}, //Page 20
	{0x24, 0x00, BYTE_LEN}, //EXP Max 16.67 fps (50Hz)
	{0x25, 0x20, BYTE_LEN},
	{0x26, 0xf2, BYTE_LEN},
	{0x27, 0x20, BYTE_LEN},
	{0x28, 0x00, BYTE_LEN}, //EXPMin 25210.08 fps
	...
	{0x03, 0x00, BYTE_LEN}, //PAGE 0
	{0x90, 0x06, BYTE_LEN}, //BLC_TIME_TH_ON  // STEVE for 50hz
	{0x91, 0x06, BYTE_LEN}, //BLC_TIME_TH_OFF // STEVE for 50hz
	{0x92, 0xe8, BYTE_LEN}, //BLC_AG_TH_ON  //STEVE AGC OxD0
	{0x93, 0xe0, BYTE_LEN}, //BLC_AG_TH_OFF //STEVE AGC OxD0

	//DCDC
	{0x03, 0x02, BYTE_LEN}, //PAGE 2
	{0xd4, 0x06, BYTE_LEN}, //DCDC_TIME_TH_ON	// STEVE for 50hz
	{0xd5, 0x06, BYTE_LEN}, //DCDC_TIME_TH_OFF // STEVE for 50hz
	{0xd6, 0xe8, BYTE_LEN}, //DCDC_AG_TH_ON
	{0xd7, 0xe0, BYTE_LEN}, //DCDC_AG_TH_OFF
...
HI351_I2C_REG_STRUCT HI351_Video_15fps_Setting[2][102]={
{//60Hz
	...
	{0x22, 0x4d, BURST_TYPE},
	{0x23, 0xa0, BURST_TYPE},
	{0x24, 0x00, BURST_TYPE}, //EXP Max 30.00 fps
	{0x25, 0x12, BURST_TYPE},
	{0x26, 0x4d, BURST_TYPE},
	{0x27, 0xa0, BURST_TYPE},
...
{//50Hz
	...
	{0x20, 0x00, BURST_TYPE}, //EXP Normal 33.33 fps (STEVE for 50Hz)
	{0x21, 0x10, BURST_TYPE},
	{0x22, 0x79, BURST_TYPE},
	{0x23, 0x10, BURST_TYPE},
	{0x24, 0x00, BURST_TYPE}, //EXP Max 33.33 fps (STEVE for 50Hz)
	{0x25, 0x10, BURST_TYPE},
	{0x26, 0x79, BURST_TYPE},
	{0x27, 0x10, BURST_TYPE},
	...
	{0x90, 0x03, BYTE_LEN}, //BLC_TIME_TH_ON  //STEVE for 50hz
	{0x91, 0x03, BYTE_LEN}, //BLC_TIME_TH_OFF //STEVE for 50hz
	{0x92, 0xe8, BYTE_LEN}, //BLC_AG_TH_ON    STEVE fixed AGC 0xD0
	{0x93, 0xe0, BYTE_LEN}, //BLC_AG_TH_OFF   STEVE fixed AGC 0xD0

	//DCDC
	{0x03, 0x02, BYTE_LEN}, //PAGE 2
	{0xd4, 0x03, BYTE_LEN}, //DCDC_TIME_TH_ON	//STEVE for 50hz
	{0xd5, 0x03, BYTE_LEN}, //DCDC_TIME_TH_OFF //STEVE for 50hz
...
HI351_I2C_REG_STRUCT HI351_scene_normal_Setting[2][114]={
{//60Hz
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x0A, DELAY_TYPE},
	...
	{0xb9, 0x66, BYTE_LEN}, // STEVE outdoor bluish bOutRgainMin_a00_n00
	{0xba, 0x88, BYTE_LEN}, // STEVE outdoor bluish //bOutRgainMax_a00_n00
	{0xbb, 0x4c, BYTE_LEN}, // STEVE outdoor bluish //bOutBgainMin_a00_n00
	{0xbc, 0x62, BYTE_LEN}, // STEVE outdoor bluish bOutBgainMax_a00_n00
...
{//50Hz
	...
	//FPS Auto
	{0x03, 0x20, BYTE_LEN},
	{0x24, 0x00, BYTE_LEN}, //EXP Max 8.33 fps (STEVE FOR 50Hz)
	{0x25, 0x41, BYTE_LEN},
	{0x26, 0xe4, BYTE_LEN},
	{0x27, 0x40, BYTE_LEN},
...
HI351_I2C_REG_STRUCT HI351_scene_portrait_Setting[2][114]={
{//60Hz
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x0A, DELAY_TYPE},
	{0x03, 0xc4, BYTE_LEN},
...
HI351_I2C_REG_STRUCT HI351_scene_landscape_Setting[2][114]={
{//60Hz
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x0A, DELAY_TYPE},
	...
	//SATB
	{0x2b, 0x80, BURST_TYPE},//SATB_00"
	{0x2c, 0x80, BURST_TYPE},//SATB_01"
	{0x2d, 0x80, BURST_TYPE},//SATB_02"
	{0x2e, 0xaa, BURST_TYPE},//SATB_03"
	{0x2f, 0xa4, BURST_TYPE},//SATB_04"
	{0x30, 0xa4, BURST_TYPE},//SATB_05"
	...
	//SATR
	{0x37, 0x80, BURST_TYPE},//SATR_00"
	{0x38, 0x80, BURST_TYPE},//SATR_01"
	{0x39, 0x80, BURST_TYPE},//SATR_02"
	{0x3a, 0x9a, BURST_TYPE},//SATR_03"
	{0x3b, 0x98, BURST_TYPE},//SATR_04"
	{0x3c, 0x98, BURST_TYPE},//SATR_05"
	{0x3d, 0x9c, BURST_TYPE},//SATR_06"
	{0x3e, 0x9c, BURST_TYPE},//SATR_07"
	{0x3f, 0x9c, BURST_TYPE},//SATR_08"
	{0x40, 0x9c, BURST_TYPE},//SATR_09"
	{0x41, 0x9c, BURST_TYPE},//SATR_10"
	{0x42, 0x9c, BURST_TYPE},//SATR_11"
...
HI351_I2C_REG_STRUCT HI351_scene_sport_Setting[2][114]={
{//60Hz
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x0A, DELAY_TYPE},
...
HI351_I2C_REG_STRUCT HI351_scene_sunset_Setting[2][115]={
{//60Hz
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x0A, DELAY_TYPE},
	{0x03, 0xc4, BYTE_LEN},
	...
	{0x03, 0xc6, BYTE_LEN},
	{0x18, 0x59, BYTE_LEN}, //bInRgainMin
	{0x19, 0x61, BYTE_LEN}, //bInRgainMax
	{0x1a, 0x66, BYTE_LEN}, //bInBgainMin
	{0x1b, 0x6e, BYTE_LEN}, //bInBgainMax

	{0xb9, 0x59, BYTE_LEN}, //bOutRgainMin
	{0xba, 0x61, BYTE_LEN}, //bOutRgainMax
	{0xbb, 0x66, BYTE_LEN}, //bOutBgainMin
	{0xbc, 0x6e, BYTE_LEN}, //bOutBgainMax

	//Saturation 0
	{0x03, 0xd1, BYTE_LEN}, //page D1(Adaptive)
	// Cb
	{0x2b, 0x98, BURST_TYPE}, //SATB_00 STEVE for Low Light
	{0x2c, 0x98, BURST_TYPE}, //SATB_01 STEVE for Low Light
	{0x2d, 0x98, BURST_TYPE}, //SATB_02 STEVE for Low Light
	{0x2e, 0x98, BURST_TYPE}, //SATB_03
	{0x2f, 0x98, BURST_TYPE}, //SATB_04
	{0x30, 0x98, BURST_TYPE}, //SATB_05
	{0x31, 0xa0, BURST_TYPE}, //SATB_06
	...
	// Cr
	{0x37, 0x98, BURST_TYPE}, //SATR_00 STEVE for Low Light
	{0x38, 0x98, BURST_TYPE}, //SATR_01 STEVE for Low Light
	{0x39, 0xa0, BURST_TYPE}, //SATR_02 STEVE for Low Light
	{0x3a, 0x98, BURST_TYPE}, //SATR_03
	{0x3b, 0x98, BURST_TYPE}, //SATR_04
	{0x3c, 0x98, BURST_TYPE}, //SATR_05
	{0x3d, 0xa0, BURST_TYPE}, //SATR_06
...
HI351_I2C_REG_STRUCT HI351_scene_night_Setting[2][114]={
{//60Hz
	{0x03, 0xFE, DELAY_TYPE},
	{0xFE, 0x0A, DELAY_TYPE},
	{0x03, 0xc4, BYTE_LEN},
